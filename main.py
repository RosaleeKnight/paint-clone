...
class PaintGUI:
	def __init__(self):
		...
		self.bplus_btn = Button(self.btn_frame,
		                        text="B+",
		                        command=self.brush_plus)
		self.bplus_btn.grid(row=0, column=0, sticky=W + E)

		self.bminus_btn = Button(self.btn_frame,
		                         text="B-",
		                         command=self.brush_minus)
		self.bminus_btn.grid(row=1, column=0, sticky=W + E)

		self.colour_btn = Button(self.btn_frame,
		                         text="Change Colour",
	...
	def on_closing(self):
		answer = messagebox.askyesnocancel("Quit",
